        ...
        <div className="fixed inset-0 bg-background flex items-center justify-center z-[9999]">
            <div className="w-40">
                <svg
                    ...
                    className="w-full h-auto text-black dark:text-white animate-pulse"
                    fill="currentColor"
                >
                    <svg id="Component_41_1" data-name="Component 41 – 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 112.769 108.171">
                        <g id="Group_9">
