...
import { Tasks } from "@/components/courses/course/course-tasks";


export default function TaskPage({ params }: { params: Promise<{ courseCode: string }> }) {
            ...
            {!course ? <LoadingScreen /> : (
                <div>
                    ...
                    <div className="@container/main flex flex-1 flex-col mt-4">
                        <Tasks course={course} courseTasks={course.tasks} courseCode={course.courseCode}/>
                    </div>
                </div>
            )}
        </div>
