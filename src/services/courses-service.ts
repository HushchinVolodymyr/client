...
export const createCourseAsync = async (createCourseDto: ICreateCourseDTO) => {
    try {
...
export const editCourseAsync = async (editCourseDto: IEditCourseDTO, courseCode: string) => {
    try {
        const formData = new FormData();
...
export const deleteCourseAsync = async (courseCode: string) => {
    try {
